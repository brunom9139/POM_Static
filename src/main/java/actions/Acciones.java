...
public class Acciones {
    ...
    public static void clickEscribirFlechaAbajoEnter(By locator, String text){
        Actions actions = new Actions(WebDriverManager.getDriver());
        actions.click(BuscarElemento.buscarElemento(locator))
                .sendKeys(text)
    ...
    public void control_A(By locator){
        Actions actions = new Actions(WebDriverManager.getDriver());
        actions.moveToElement(BuscarElemento.buscarElemento(locator))
    ...
    public static void borrarTexto(By locator){
        Actions actions = new Actions(WebDriverManager.getDriver());
        actions.moveToElement(BuscarElemento.buscarElemento(locator)).sendKeys(Keys.DELETE).perform();
    }
}
