...
public class EsperarHasta {
    ...
    public static WebElement presente(By locator) {
        ...
        try {
            ...
            esperar.until(ExpectedConditions.and(ExpectedConditions.presenceOfElementLocated(locator), ExpectedConditions.visibilityOfElementLocated(locator), ExpectedConditions.elementToBeClickable(locator)));
